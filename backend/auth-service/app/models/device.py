...
class Device(Base):
    ...
    client_device_id: Mapped[str | None] = mapped_column(String(255), unique=True, nullable=True, index=True)
    ...
    revoked_by_device_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), nullable=True)
