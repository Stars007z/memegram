...
from app.services.interfaces.media_service import DownloadUrlResult, IMediaService, UploadInitResult
...
class MediaServiceImpl(IMediaService):
    ...
    async def initiate_upload(
        ...
        if encrypted_size > settings.MAX_UPLOAD_SIZE_BYTES:
            raise ValueError(f"INVALID_ARGUMENT: File too large (max {settings.MAX_UPLOAD_SIZE_BYTES} bytes)")
